const elderlyCareTheme = {
  ...
  token: {
    colorPrimary: '#0066ff',
    colorPrimaryHover: '#ff6b00',
    colorPrimaryActive: '#ff6b00',
    colorLink: '#0066ff',
    colorLinkHover: '#ff6b00',
    ...
    boxShadowSecondary: '0 18px 48px rgba(18, 63, 53, 0.12)'
  },
  components: {
    Button: {
      fontWeight: 400,
    ...
    Menu: {
      itemColor: '#1f2937',
      itemHoverColor: '#ff6b00',
      itemSelectedColor: '#ff6b00',
      itemSelectedBg: '#edf3ff',
      itemHoverBg: '#fff4ec',
      horizontalItemHoverColor: '#ff6b00',
      horizontalItemSelectedColor: '#ff6b00',
      darkItemBg: '#0066ff',
