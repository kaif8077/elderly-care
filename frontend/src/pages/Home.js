        ...
        <Flex vertical gap={64} style={{ width: 'min(1200px, calc(100% - 32px))', margin: '64px auto' }}>
          <section aria-labelledby="problem-title">
            <Flex vertical align="center" gap={8}>
              ...
              <h6 id="problem-title" className="care-section-heading care-problem-heading care-secondary-heading">Emergency information is often scattered or unavailable</h6>
          ...
          <section aria-labelledby="features-title">
            <Flex vertical align="center" gap={8}>
              ...
              <h6 id="features-title" className="care-section-heading care-secondary-heading">Built for preparation, privacy, and faster emergency action</h6>
              ...
              <Row align="stretch">
                ...
                <Col xs={24} lg={12}>
                  <Flex vertical justify="center" style={{ height: '100%', minHeight: 430, padding: 'clamp(28px, 5vw, 56px)' }}>
                    ...
                    <h6 id="trust-title" className="care-section-heading care-section-heading-left care-secondary-heading">Useful in emergencies without publishing the complete record</h6>
          ...
          <section aria-labelledby="faq-title">
            <Flex vertical align="center" gap={8}>
              ...
              <h6 id="faq-title" className="care-section-heading care-faq-heading care-secondary-heading">Understand how emergency access works</h6>
            </Flex>
            <Collapse
              accordion
              bordered={false}
