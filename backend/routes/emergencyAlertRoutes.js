...
router.post(
  '/public/:token',
  simpleRateLimit({ windowMs: 60_000, limit: 5, keyPrefix: 'emergency-alert' }),
  createPublicAlert
);
router.patch(
  '/acknowledge/:token',
  simpleRateLimit({ windowMs: 60_000, limit: 10, keyPrefix: 'alert-ack' }),
  acknowledgePublicAlert
);
...
router.patch(
  '/mine/:id/acknowledge',
  authMiddleware,
  simpleRateLimit({ windowMs: 60_000, limit: 20, keyPrefix: 'account-alert-ack' }),
  acknowledgeMyAlert
);
