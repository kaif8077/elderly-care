...
const adminEmergencyAlertRoutes = require('./routes/adminEmergencyAlertRoutes');
...
app.use('/api/admin/emergency-alerts', adminEmergencyAlertRoutes);
...
app.use('*', (req, res) => {
  res.status(404).json({
    ...
    availableRoutes: ['/', '/api', '/api/qr', '/api/auth', '/api/medical']
  });
});
