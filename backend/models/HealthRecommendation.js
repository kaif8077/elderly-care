...
const healthRecommendationSchema = new mongoose.Schema({
  ...
  sourceSummary: {
    conditions: [{ type: String }], allergies: [{ type: String }], medications: [{ type: String }],
    symptoms: [{ type: String }], mobilityStatus: { type: String, default: null }, fallRisk: { type: Boolean, default: false }
  },
  feedback: {
