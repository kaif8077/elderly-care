...
const medicalProfileSchema = new mongoose.Schema({
    ...
    emergencyContacts: [{
        ...
        preferredChannel: { type: String, enum: ['email', 'phone', 'sms', 'telegram'], default: 'phone' },
    ...
    visibilitySettings: {
        type: Map,
        of: { type: String, enum: ['public_emergency', 'emergency_contacts', 'owner_only', 'hidden'] },
        default: () => ({
            name: 'public_emergency', approximateAge: 'public_emergency', bloodGroup: 'public_emergency',
            allergies: 'public_emergency', medicalHistory: 'public_emergency', medications: 'public_emergency',
            mobilityStatus: 'public_emergency', preferredLanguage: 'public_emergency',
            phone: 'owner_only', address: 'owner_only', insurance: 'owner_only'
        })
    },
    consent: {
