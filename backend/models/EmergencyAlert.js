...
const emergencyAlertSchema = new mongoose.Schema(
  {
    ...
    emergencyType: {
      type: String,
      enum: ['person_found', 'medical_emergency', 'fall', 'lost_confused', 'accident', 'other'],
    ...
    acknowledgementAction: {
      type: String,
      enum: ['received', 'calling', 'going_to_location', 'services_contacted', 'resolved', null],
      default: null
    },
    ...
    acknowledgementHistory: [
      {
        action: {
          type: String,
          enum: ['received', 'calling', 'going_to_location', 'services_contacted', 'resolved'],
          required: true
        },
